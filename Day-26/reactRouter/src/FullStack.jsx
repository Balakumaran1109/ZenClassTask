...
function FullStack() {
  return (
    <div>
      <Content
        imgAddress0={
          "https://github.com/Balakumaran1109/Class-Notes/blob/main/FSD.png?raw=true"
        }
        imgAddress1={
          "https://www.prakalpana.com/wp-content/uploads/2022/01/best-full-stack-web-developer-courses-certification-online-ppjh0d5a.jpg"
        }
        imgAddress3={
